...
@section('title', __('translation.add_admin'))
@section('css')
        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('translation.dashboard') }}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('translation.add_admin') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-sm-12">
            <div class="card  box-shadow-0">
                <div class="card-header">
                    <h4 class="card-title mb-1">{{ __('translation.add_admin') }}</h4>
                </div>
                <div class="card-body pt-0">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.admins.store') }}"
                            ...
                            <div class="col-sm-12 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email"
                                        ...
                                        value="{{ old('email') }}"
                                        placeholder="{{ __('translation.please_type', ['name' => __('translation.email')]) }}"
                                        required>
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-sm-12 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('type') is-invalid @enderror" id="type" name="type">
                                        ...
                                        <option value="sub-admin" {{ old('type') == 'sub-admin' ? 'selected' : '' }}>
                            ...
                            <div class="col-sm-12 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password"
                                        ...
                                        value="{{ old('password') }}"
                                        placeholder="{{ __('translation.please_type', ['name' => __('translation.password')]) }}"
                                        required>
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
