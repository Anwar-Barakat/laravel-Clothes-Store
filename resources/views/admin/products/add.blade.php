                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('fabric') is-invalid @enderror" id="fabric"
                                        ...
                                        @foreach (App\Models\Product::fabricArray as $fabric)
                                            <option value="{{ __('translation.' . $fabric) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('pattern') is-invalid @enderror" id="pattern"
                                        ...
                                        @foreach (App\Models\Product::patternArray as $pattern)
                                            <option value="{{ __('translation.' . $pattern) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('sleeve') is-invalid @enderror" id="sleeve"
                                        ...
                                        @foreach (App\Models\Product::sleeveArray as $sleeve)
                                            <option value="{{ __('translation.' . $sleeve) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('fit') is-invalid @enderror" id="fit" name="fit">
                                        ...
                                        @foreach (App\Models\Product::fitArray as $fit)
                                            <option value="{{ __('translation.' . $fit) }}">
                            ...
                            <div class="col-sm-12 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('occasion') is-invalid @enderror" id="occasion"
                                        name="occasion">
                                        <option value="">{{ __('translation.choose..') }}</option>
                                        @foreach (App\Models\Product::occasionArray as $occasion)
                                            <option value="{{ __('translation.' . $occasion) }}">
