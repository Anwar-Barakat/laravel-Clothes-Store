            ...
            <div class="row">
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                    ...
                    <div class="wrap-shop-control">
                        <h1 class="shop-title">{{ __('frontend.digitals') }} & {{ __('frontend.electronic') }}</h1>
                        <div class="wrap-right">
                            <div class="sort-item orderby ">
                                <select name="orderby" class="use-chosen">
                                    <option value="menu_order" selected="selected">{{ __('frontend.default_sorting') }}
                                    </option>
                    ...
                    <div class="widget mercado-widget filter-widget">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="widget-banner">
                                <figure><img src="{{ asset('front/assets/images/size-banner-widget.jpg') }}" width="270"
                                        height="331" alt="">
                                </figure>
                            </div>
                        </div>
