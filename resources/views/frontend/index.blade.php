                                ...
                                <li class="menu-item lang-menu menu-item-has-children parent">
                                    <a title="English" href="#">
                                        <span class="img label-before">
                                            <img src="{{ asset('front/assets/images/lang-en.png') }}" alt="lang-en">
                                        </span>
                                        English
                                    ...
                                    <ul class="submenu lang">
                                        <li class="menu-item">
                                            <a title="hungary" href="#">
                                                <span class="img label-before">
                                                    <img src="{{ asset('front/assets/images/lang-hun.png') }}"
                                                        alt="lang-hun">
                                                </span>
                                                Hungary
                                            </a>
                                        ...
                                        <li class="menu-item">
                                            <a title="german" href="#">
                                                <span class="img label-before">
                                                    <img src="{{ asset('front/assets/images/lang-ger.png') }}"
                                                        alt="lang-ger">
                                                </span>
                                                German
                                            </a>
                                        ...
                                        <li class="menu-item">
                                            <a title="french" href="#">
                                                <span class="img label-before">
                                                    <img src="{{ asset('front/assets/images/lang-fra.png') }}"
                                                        alt="lang-fre">
                                                </span>
                                                French
                                            </a>
                                        ...
                                        <li class="menu-item">
                                            <a title="canada" href="#">
                                                <span class="img label-before">
                                                    <img src="{{ asset('front/assets/images/lang-can.png') }}"
                                                        alt="lang-can">
                                                </span>
                                                Canada
                                            </a>
                    ...
                    <div class="mid-section main-info-area">
                        ...
                        <div class="wrap-logo-top left-section">
                            <a href="index.html" class="link-to-home"><img
                                    src="{{ asset('front/assets/images/logo-top-1.png') }}" alt="mercado"></a>
                        </div>
            ...
            <div class="wrap-show-advance-info-box style-1">
                ...
                <div class="wrap-top-banner">
                    <a href="#" class="link-banner banner-effect-2">
                        <figure><img src="{{ asset('front/assets/images/digital-electronic-banner.jpg') }}"
                            ...
                            <div class="wrap-footer-item">
                                ...
                                <div class="item-content">
                                    <div class="wrap-list-item wrap-gallery">
                                        <img src="{{ asset('front/assets/images/payment.png') }}"
                                        ...
                                        <ul>
                                            <li>
                                                <a href="#" class="link-to-item"
                                                    ...
                                                    <figure><img
                                                            src="{{ asset('front/assets/images/brands/apple-store.png') }}"
                                            ...
                                            <li>
                                                <a href="#" class="link-to-item"
                                                    ...
                                                    <figure><img
                                                            src="{{ asset('front/assets/images/brands/google-play-store.png') }}"
