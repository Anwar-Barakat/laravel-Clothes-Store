                        ...
                        <div class="row row-sm">
                            <div class="col-lg-6">
                                <div class="form-group has-success mg-b-0">
                                    ...
                                    <textarea class="form-control mg-t-20" placeholder="Textarea (success state)" required=""
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            <label class="ckbox"><input checked type="checkbox"><span>Checkbox
                                    Checked</span></label>
                        </div>
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            <label class="ckbox"><input disabled type="checkbox"><span>Checkbox
                                    Disabled</span></label>
                        </div>
                    </div>
        ...
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mg-b-5">Set the numberOfMonths option to an integer of 2 or more to show multiple
                        months in a single datepicker.</p>
                    <div class="row row-sm mg-b-20">
                        <div class="input-group col-md-4">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row row-sm mg-b-20">
                        ...
                        <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                            <p class="mg-b-10">Single Select (Disabled)</p><select class="form-control select2"
                                disabled>
                                <option label="Choose one">
                                </option>
                                <option value="Firefox">
