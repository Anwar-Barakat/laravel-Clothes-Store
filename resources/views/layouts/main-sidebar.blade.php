        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-peity')) }}">Chart-peity</a>
                    </li>
                </ul>
            </li>
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item"
                            href="{{ url('/' . ($page = 'product-details')) }}">Product-Details</a>
                    </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item"
                            href="{{ url('/' . ($page = 'darggablecards')) }}">Darggablecards</a>
                    </li>
